...
This thesis presents an eye-tracking study, investigating the effects of indentation and commenting formats on novices’ perception of code. Eye-tacking technology helps to visualize the eye movements of beginners and make suggestions about their cognitive load. 
...
The eye-tracking study by \citet{broberg2019using} investigates how different variable naming conventions impact on code readability.  
...
\node (eyeTracking) [draw, minimum height=2.2cm, minimum width=3.5cm, text width=3cm, align=center] {Eye-tracking};
\node (questionnaire) [draw, minimum height=2.2cm, minimum width=3.5cm, text width=3cm, align=center, right=1.8cm of eyeTracking] {Questionnaire};
\node (questionnaire2) [draw, minimum height=2.2cm, minimum width=3.5cm, text width=3cm, align=center, right=1.8cm of questionnaire] {Questionnaire};

\node (offlineStudy) [draw, minimum height=2.2cm, minimum width=3.5cm, text width=3.2cm, align=center, below=1.8cm of eyeTracking] {Offline study};

\node (onlineStudy) [draw, minimum height=2.2cm, minimum width=3.5cm, text width=3.2cm, align=center, below=1.8cm of questionnaire2] {Online study};

\node (study) [draw, minimum height=2.2cm, minimum width=6.5cm, text width=6.5cm, align=center, below=1.8cm of $(onlineStudy)!0.5!(offlineStudy)$] {The study};
...
\begin{figure} [H]
  \centering
  \includegraphics[scale=0.8]{figures/codeb.png}
