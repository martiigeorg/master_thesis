...
Previous research has also used both methods to gather data for a deeper code comprehension. (see Chapter Literature review). 
...
\node (questionnaire2) [draw, minimum height=2.5cm, minimum width=3cm, text width=2.6cm, right=2.2cm of questionnaire] {Questionnaire2};
...
The independent variables influence the dependent variables. The dependent variables are measured and the outcomes help to investigate how the independent variables influence code comprehension, commenting format, and indentation level.
